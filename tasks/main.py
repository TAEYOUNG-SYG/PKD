    ...
    def train(self, train_loader, val_loader):
        ...
        for epoch in range(args.epochs):
            ...
            for i, (feats, boxes, sent, target, ques_id) in tqdm(enumerate(train_loader)):
                ...
                if i and i % 100 == 0:
                    log_str = 'traing: %d/%d, train_loss: %.6f, bce_loss: %.6f, q_bce_loss: %.6f, v_bce_loss: %.6f, debias_bce_loss: %.6f, constrast_loss: %.6f, self_loss: %.6f, neg_train_q_acc: %.6f, neg_train_v_acc: %.6f, pos_train_acc: %.6f, l2_loss: %.6f' % (
                    ...
                    100 * train_score_pos / total_num, total_l2_loss/total_num)
                    print(log_str)
